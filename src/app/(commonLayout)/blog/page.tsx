            ...
            <div>
                        ...
                        <div className="row">
                            <div className="col-lg-5 col-md-12">
                                <div className="content">
                                    ...
                                    <p>
                                        Stay ahead with our expert digital
                                        insights, offering the latest trends and
                                        strategies to help drive your success in
                                        the digital world.
                                    </p>
                                </div>
                            </div>
                            <div className="col-lg-7 col-md-12">
                                <div className="image" data-cue="slideInUp">
                                    ...
                                    >
                                        <img
                                            src="assets/images/blogs/blog13.jpg"
                                            alt="blog-image"
                                        />
                                    </a>
                ...
                <div className="blog-area ptb-150">
                    <div className="container">
                        ...
                        <div className="main-blogs-list" data-cues="slideInUp">
                            <div className="item">
                                <div className="row align-items-center">
