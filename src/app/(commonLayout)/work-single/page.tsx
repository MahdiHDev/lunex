            ...
            <div>
                ...
                <div className="design-principles-area ptb-150">
                    <div className="container">
                        ...
                        <div
                            className="design-principles-content"
                            data-cues="slideInUp"
                        >
                            <div className="row">
                                <div className="col-lg-7 col-md-12">
                                    <div className="image">
                                        <img
                                            src="assets/images/design-principles.jpg"
                            ...
                            <div className="item">
                                <div className="row">
                                    ...
                                    <div className="col-lg-5 col-md-12">
                                        <div className="content">
                                            <p className="fw-medium">
                                                Every design element is crafted
                                                with simplicity in mind,
                                                ensuring users can easily
                                                understand and navigate the
                                                interface. We remove unnecessary
                                    ...
                                    <div className="col-lg-5 col-md-12">
                                        <div className="content">
                                            <p className="fw-medium">
                                                ...
                                                building a recognizable and
                                                trusted brand. We maintain
                                                uniformity in typography,
                                                colors, and layout to create a
                                                cohesive and predictable user
                                    ...
                                    <div className="col-lg-5 col-md-12">
                                        <div className="content">
                                            <p className="fw-medium">
                                                ...
                                                designs. Each element is
                                                strategically placed and
                                                optimized to enhance usability,
                                                allowing users to accomplish
                                                their goals with ease, whether
                                                it's navigating a website or
                        ...
                        <div className="row" data-cues="slideInUp">
                            <div className="col-12">
                                <div className="single-mockup-item text-center">
                                    <img
                                        src="assets/images/mockups/mockup1.jpg"
                                        alt="mockup-image"
                                    />
                                </div>
                            </div>
                            <div className="col-6">
                                <div className="single-mockup-item text-center">
                                    <img
                                        src="assets/images/mockups/mockup2.jpg"
                                        alt="mockup-image"
                                    />
                                </div>
                            </div>
                            <div className="col-6">
                                <div className="single-mockup-item text-center">
                                    <img
                                        src="assets/images/mockups/mockup3.jpg"
                                        alt="mockup-image"
                                    />
                                </div>
                            </div>
                ...
                <div className="impact-area pb-150">
                    <div className="container">
                        ...
                        <div className="impact-list" data-cues="slideInUp">
                            <div className="item">
                                <div className="row align-items-center">
                                    <div className="col-lg-5 col-md-4">
                                        <div className="icon rounded-circle d-flex align-items-center justify-content-center">
                                            <img
                                                src="assets/images/icons/touch-id.svg"
                                                alt="icon"
                                            />
                                        </div>
                                    </div>
                            ...
                            <div className="item">
                                <div className="row align-items-center">
                                    <div className="col-lg-5 col-md-4">
                                        <div className="icon rounded-circle d-flex align-items-center justify-content-center">
                                            <img
                                                src="assets/images/icons/economic-growth.svg"
                                                alt="icon"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-3 col-md-4">
                                        <p>
                                            By focusing on clarity and
                                            usability, we create intuitive
                                            platforms that increase user
                                            satisfaction and promote brand
                                            loyalty.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="item">
                                <div className="row align-items-center">
                                    <div className="col-lg-5 col-md-4">
                                        <div className="icon rounded-circle d-flex align-items-center justify-content-center">
                                            <img
                                                src="assets/images/icons/dissatisfaction.svg"
                                                alt="icon"
                                            />
                                        </div>
                                    </div>
