        ...
        <div>
            <div>
                ...
                <div className="blog-details-page-banner-area">
                    <div className="container">
                        <div className="title mx-auto text-center text-animation">
                        ...
                        <div className="content" data-cue="slideInUp">
                            <h3>Growth</h3>
                            <img
                                src="assets/images/blogs/blog-details1.jpg"
                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-7 col-md-12">
                                <div className="blog-details-desc">
                                    ...
                                    <img
                                        src="assets/images/blogs/blog-details2.jpg"
                                        alt="blog-details-image"
                                    />
