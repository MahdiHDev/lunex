            ...
            <div>
                ...
                {/* <div className="reviews_area position-relative z-1">
                    <div className="container-fluid max_w_1560px">
                        ...
                        <div
                            className="total_reviews lh-1 d-flex align-items-center"
                            data-cue="slideInUp"
                        >
                        ...
                        <div
                            className="reviews_slides owl-carousel owl-theme"
                            data-cue="slideInUp"
                        >
                            <div className="review_item">
                                <div className="row align-items-center">
                                    <div className="col-md-6">
                                        <div className="content">
                                            ...
                                            <p>
                                                ...
                                                agency that empowers businesses
                                                to achieve their online goals.
                                                We are passion ate about helping
                                                our clients succeed in the
                                    ...
                                    <div className="col-md-6">
                                        <div className="image">
                                            <img
                                                src="assets/images/reviews/review1.jpg"
                                                alt="review1"
                                            />
                                        </div>
                                    </div>
                            ...
                            <div className="review_item">
                                <div className="row align-items-center">
                                    <div className="col-md-6">
                                        <div className="content">
                                            ...
                                            <p>
                                                ...
                                                businesses achieve their online
                                                goals. With a passion for
                                                driving success, we empower our
                                                clients to thrive in the
                                    ...
                                    <div className="col-md-6">
                                        <div className="image">
                                            <img
                                                src="assets/images/reviews/review2.jpg"
                                                alt="review2"
                                            />
                                        </div>
                                    </div>
                ...
                <div className="blog_area pt-150 pb-125">
                    <div className="container-fluid max_w_1560px">
                        <div className="section_title style_four position-relative">
                            <h2 className="mb-0 text-uppercase fw-semibold text_animation">
                                Thoughts &amp; insights
                            </h2>
                            <img
                                src="assets/images/icons/right_down_arrow.svg"
                                alt="right_down_arrow"
                            />
                        </div>
                        <div
                        ...
                        >
                            <div className="col-lg-4 col-sm-6">
                                <div className="single_blog_post">
                                    <div className="image position-relative overflow-hidden">
                                        <img
                                            src="assets/images/blogs-two/blog7.jpg"
                                            alt="blog7"
                                        />
                                        <a
                                    ...
                                    <h3 className="mb-0">
                                        <a href="blog-single.html">
                                            Optimized Design Sets the Foundation
                                            for Growth
                                        </a>
                                    </h3>
                                </div>
                            ...
                            <div className="col-lg-4 col-sm-6">
                                <div className="single_blog_post">
                                    <div className="image position-relative overflow-hidden">
                                        <img
                                            src="assets/images/blogs-two/blog8.jpg"
                                            alt="blog8"
                                        />
                                        <a
                                            href="blog-single.html"
                                    ...
                                    <h3 className="mb-0">
                                        <a href="blog-single.html">
                                            Intelligent Design Opens Doors to
                                            New Opportunities
                                        </a>
                                    </h3>
                                </div>
                            ...
                            <div className="col-lg-4 col-sm-6">
                                <div className="single_blog_post">
                                    <div className="image position-relative overflow-hidden">
                                        <img
                                            src="assets/images/blogs-two/blog9.jpg"
                                            alt="blog9"
                                        />
                                        <a
                                            href="blog-single.html"
                                    ...
                                    <h3 className="mb-0">
                                        <a href="blog-single.html">
                                            Transformative Design Drives Growth
                                            Potential
                                        </a>
                                    </h3>
                                </div>
                ...
                <div className="lets_talk_area position-relative z-1 pt-150">
                    <div className="container-fluid max_w_1560px">
                        <div className="lets_talk_content text-center">
                            <h2 className="text_animation">Let’s Talk</h2>
                            <a
                                href="contact.html"
                    ...
                    <div className="object9">
                        <img
                            src="assets/images/objects/object9.png"
                            alt="object9"
                        />
                    </div>
                </div>
                                ...
                                <div className="col-lg-4">
                                    <div className="footer_logo_widget">
                                        ...
                                        <p>
                                            ...
                                            mtota rem aperiam, eaque ipsa quae
                                            ab illo inve ntore veritatis et
                                            quasi architec to.
                                        </p>
                                    </div>
                                </div>
                ...
                {/* End Footer Area */}
                {/* Back To Top */}
                <div className="back_to_top style_two position-fixed text-center rounded-circle">
