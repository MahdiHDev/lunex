...
import whiteLeftArrow from "public/assets/images/icons/white-left-arrow.svg";
import whiteRightArrow from "public/assets/images/icons/white-right-arrow.svg";
...
export default function CyberTestimonial() {
